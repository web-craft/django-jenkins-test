...
/opt/dj_ci_test/ - source root
      env/ - virtual environment
      src/ - git repository
      nginx.conf
      supervisor.conf

/var/www/dj_ci_test/ - document root
      media/
      static/
"""
...
env.project_name = 'dj_ci_test'
env.repository = 'git@github.com:web-craft/dj_ci_test.git'
...
def dev():
    ...
    """
    server = 'dj_ci_test.dev.biteabyte.net'
    env.roledefs = {
